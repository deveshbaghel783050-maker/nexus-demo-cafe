...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    name: 'Demo Cafe Signature Special',
    price: 450.00,
    ...
    customizations: [
      {
        ...
        options: [
          ...
          { name: 'Demo Cafe Red Fiery (Sichuan Style)', price: 0 },
        ]
      }
    ]
  },
...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  {
    id: 'mood',
    text: 'How is the environment of Thane treating you today?',
    options: [
...
export const MOKAI_GALLERY_SPACES = [
  {
    id: 'space-mures',
    title: 'Experience Demo Cafe Interior',
    ...
    spots: [
      { x: 25, y: 35, title: 'Experience Demo Cafe Wall', txt: 'Curated signage detailing Mokai’s journey from a humble local dream to a Thane coffee sanctuary.' },
      { x: 50, y: 55, title: 'The Photo Frames', txt: 'Local creators showcase! Frames of the workers, the soil creators, and the local Thane community neighbors.' },
