...
export default function TableBookingView({ onAddBooking, openNotification }: TableBookingViewProps) {
  ...
  const handleBookingSubmit = (e: React.FormEvent) => {
    ...
    const newBooking: TableBooking = {
      id: 'DEMO_CAFE-' + Math.floor(100000 + Math.random() * 900000),
      date: selectedDate,
        ...
        <form onSubmit={handleBookingSubmit} className="space-y-6">
          <div className="text-center max-w-xl mx-auto mb-8">
            ...
            <p className="text-sm text-brand-outline font-sans">
              We hold specific corners of our Thane sanctuary for slow collaboration, readings, or quiet mindful gatherings.
            </p>
          </div>
          ...
          <div className="border-t border-[#ccc6bb]/30 pt-6">
            ...
            <div className="mt-4">
              ...
              <textarea
                rows={2}
                placeholder="Let us know what makes your Thane visit comfortable..."
                value={requests}
